    ...
    <>
      ...
      <div class="mt-6 text-justify text-base leading-relaxed tracking-tight sm:text-lg sm:tracking-normal">
        <p>
          ...
          {yearsOfExperience}+ years of experience building scalable, efficient
          systems. I love solving real problems through clean, practical
          solutions. Always learning, always curious, and driven to make an
          impact.
        </p>
      </div>
